...
module mkFBox_Core(verbosity,
  ...
  assign MUX_dw_result$wset_1__VAL_1 =
	     { x__h30041, fpu$server_core_response_get[4:0] } ;
  ...
  assign MUX_resultR$write_1__VAL_4 =
	     { 1'd1, x__h30041, fpu$server_core_response_get[4:0] } ;
  assign MUX_resultR$write_1__VAL_5 = { 1'd1, x__h29630, 5'd0 } ;
  assign MUX_resultR$write_1__VAL_6 = { 1'd1, x__h28507, x__h28287 } ;
  assign MUX_resultR$write_1__VAL_7 = { 1'd1, x__h27402, x__h28287 } ;
  assign MUX_resultR$write_1__VAL_8 = { 1'd1, x__h25885, x__h22360 } ;
  assign MUX_resultR$write_1__VAL_9 = { 1'd1, x__h25707, 5'd0 } ;
  assign MUX_resultR$write_1__VAL_10 = { 1'd1, res__h21240, 5'd0 } ;
  assign MUX_resultR$write_1__VAL_11 = { 1'd1, x__h22992, x__h22360 } ;
  assign MUX_resultR$write_1__VAL_12 = { 1'd1, x__h20328, x__h22360 } ;
  assign MUX_resultR$write_1__VAL_13 = { 1'd1, x__h19539, x__h20041 } ;
  assign MUX_resultR$write_1__VAL_14 = { 1'd1, x__h17906, x__h19242 } ;
  assign MUX_resultR$write_1__VAL_15 = { 1'd1, x__h11019, x__h17582 } ;
  assign MUX_resultR$write_1__VAL_16 = { 1'd1, x__h3813, x__h10691 } ;
  assign MUX_resultR$write_1__VAL_17 = { 1'd1, x__h3622, 5'd0 } ;
  assign MUX_resultR$write_1__VAL_18 = { 1'd1, x__h3449, 5'd0 } ;
  assign MUX_resultR$write_1__VAL_19 = { 1'd1, x__h3273, 5'd0 } ;

  // inlined wires
  assign dw_valid$wget = stateR != 2'd3 || resultR[69] ;
  assign dw_valid$whas = stateR == 2'd3 || WILL_FIRE_RL_rl_get_fpu_result ;
  ...
  always@(WILL_FIRE_RL_doFADD_S or
	  ...
	  WILL_FIRE_RL_doFSQRT_S or MUX_fpu$server_core_request_put_1__VAL_9)
  begin
  ...
  assign fpu$EN_server_core_request_put =
	     ...
	     WILL_FIRE_RL_doFDIV_S ||
	     WILL_FIRE_RL_doFSQRT_S ;
  assign fpu$EN_server_core_response_get = WILL_FIRE_RL_rl_get_fpu_result ;
  assign fpu$EN_server_reset_request_put = WILL_FIRE_RL_rl_reset_begin ;
  assign fpu$EN_server_reset_response_get = WILL_FIRE_RL_rl_reset_end ;

  // submodule frmFpuF
  assign frmFpuF$D_IN = 1'b0 ;
  assign frmFpuF$ENQ = 1'b0 ;
  assign frmFpuF$DEQ = 1'b0 ;
  assign frmFpuF$CLR = WILL_FIRE_RL_rl_reset_begin ;

  // submodule resetReqsF
  assign resetReqsF$ENQ = EN_server_reset_request_put ;
  assign resetReqsF$DEQ = WILL_FIRE_RL_rl_reset_begin ;
  assign resetReqsF$CLR = 1'b0 ;

  // submodule resetRspsF
  assign resetRspsF$ENQ = WILL_FIRE_RL_rl_reset_end ;
  ...
  assign res__h30122 = { 32'hFFFFFFFF, fpu$server_core_response_get[36:5] } ;
